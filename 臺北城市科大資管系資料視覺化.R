...
n=ChickWeight
n1=subset(n,Chick==1)
plot(x=n1$Time,y=n1$weight,type='o',main="Chicken 1",las=1,lwd=2,xlab="Time",ylab="Weight",col=2)
n35=subset(n,Chick==1)
plot(x=n1$Time,y=n1$weight,type='o',main="Chicken 35",las=1,lwd=2,xlab="Time",ylab="Weight",col=5)
...
plot(x=n2$Time,y=n9$weight,type='o',main="Chicken 2",las=1,lwd=2,xlab="Time",ylab="Weight",col=2)
...
plot(x=n18$Time,y=n18$weight,type='o',main="Chicken 18", las=1,lwd=2,xlab="Time",ylab="Weight",col=3, xlim=c(0,21),ylim=c(0,250))
plot(x=d1$Time,y=d1$weight,type='p',main="Diet 1",las=1,xlab="Time",ylab="Weight")
plot(x=n24$Time,y=n24$weight,type='o',main="Chicken 24",las=1,lwd=2,xlab="Time",ylab="Weight",col="blue4")
plot(x=n25$Time,y=n25$weight,type='o',main="Chicken 25",las=1,lwd=2,xlab="Time",ylab="Weight",col="blue4")
plot(x=n26$Time,y=n26$weight,type='o',main="Chicken 26",las=1,lwd=2,xlab="Time",ylab="Weight",col="blue4")
plot(x=d2$Time,y=d2$weight,type='p',main="Diet 2",las=1,xlab="Time",ylab="Weight",col="blue4")
# 擷取1-4號食譜的所有資料
d1=subset(ChickWeight, Diet==1)
d2=subset(ChickWeight, Diet==2)
